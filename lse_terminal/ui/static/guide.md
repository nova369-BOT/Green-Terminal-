...
MY DATA is your library: files you import, files you download from LSE Data or Binance, and the ten samples. Everything under BACKTEST, the WORKSPACE tools and the RESEARCH model fits read from here.
